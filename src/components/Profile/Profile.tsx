...
import SkeletonProfile from '../utils/Skeleton/SkeletonProfile';
        ...
        <>
            ...
            <div className="bg-white rounded-lg p-6 flex-col">
              ...
              <div className="flex justify-center mt-10">
                ...
                >
                  ...
                  <span className="text-xs pl-0.5">
                    {t('profile.forms.editProfile.btn')}
                  </span>
                </div>
              </div>
          ...
          <Modal
            modalContent={
              <ChangePasswordForm
                profile={profileData}
                manageCloseModal={changePasswordCloseClick}
              />
            }
          ...
          <Modal
            modalContent={
              <EditProfileForm
                profile={profileData}
                manageCloseModal={editProfileCloseClick}
              />
            }
