    ...
    <>
      {(() => {
        if (status !== '') {
          if (status === 'Error') {
            return (
              <div className="inline-flex items-center bg-red-200 leading-none text-red-600 rounded-md p-2 shadow text-teal text-sm">
            ...
            return (
              <div className="inline-flex items-center bg-green-200 leading-none text-green-600 rounded-md p-2 shadow text-teal text-sm">
